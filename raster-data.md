...
<br> [Open QGIS 3.32 Desktop.](https://qgis.org/download/){:target="_blank"} From the *‘Project’* menu, select *‘Save As’*. Navigate your file folder and save the QGIS project in the same folder as the rest of your data. Name it *'yourname_map'*.<br>
